...
- 설명: Accepted but not yet fully completed; deprecated for several SIP usages but still registered by IANA.
- 대표 상황: Legacy asynchronous acceptance of MESSAGE, SUBSCRIBE, or REFER-related processing.
- 관련 메서드: MESSAGE, SUBSCRIBE, REFER
